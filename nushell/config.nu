...
if not (echo "~/.cache/zoxide/init.nu" | path exists) {
  ...
  zoxide init nu | save ~/.cache/zoxide/init.nu
}

if not (echo "~/.cache/starship/init.nu" | path exists) {
  echo "Initializing starship cache"
...
use argx
use docker *
source after/after.nu
use nuguish *
#source kubectl/kubectl-completions.nu
# end fancynugets
